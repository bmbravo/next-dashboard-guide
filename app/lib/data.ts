...
export async function fetchPokemon(pokemon: string): Promise<PokemonResponse> {
  try {
    ...
    // Aquí Axios ya devuelve la data directamente en resp.data, no necesitas otra envoltura
    return resp.data;
  } catch (err) {
